        ...
        <div className="min-h-screen flex items-center justify-center px-6 py-20">
            <div className="w-full max-w-sm">
                <div className="text-center mb-10">
                    ...
                    <h1 className="text-2xl font-bold text-[rgb(var(--color-text-primary))]">다시 오신 것을 환영합니다</h1>
                ...
                <p className="text-center text-sm text-[rgb(var(--color-text-secondary))] mt-8">
                    계정이 없으신가요?{' '}
                    <Link href="/signup" className="text-[rgb(var(--color-accent))] hover:underline font-medium">
                        회원가입
                    </Link>
                </p>
            </div>
    ...
    return (
        <Suspense fallback={
            <div className="min-h-screen flex items-center justify-center">
                <div className="w-6 h-6 border-2 border-[rgb(var(--color-border))] border-t-[rgb(var(--color-text-primary))] rounded-full animate-spin" />
            </div>
        }>
            <LoginForm />
        </Suspense>
