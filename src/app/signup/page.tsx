        ...
        return (
            <div className="min-h-screen flex items-center justify-center px-6 py-20">
                <div className="w-full max-w-sm text-center">
                    ...
                    <h1 className="text-2xl font-bold text-[rgb(var(--color-text-primary))] mb-3">이메일을 확인해주세요</h1>
                    <p className="text-sm text-[rgb(var(--color-text-secondary))] leading-relaxed mb-8">
                        <span className="text-[rgb(var(--color-text-primary))] font-medium">{email}</span>로 인증 링크를 보냈습니다.
                        <br />
            ...
            <div className="w-full max-w-sm">
                <div className="text-center mb-10">
                    <Link href="/" className="inline-flex items-center gap-2.5 mb-8">
                        ...
                        <span className="font-bold text-lg tracking-tight text-[rgb(var(--color-text-primary))]">DetailPage</span>
                    </Link>
                    <h1 className="text-2xl font-bold text-[rgb(var(--color-text-primary))]">계정 만들기</h1>
                ...
                <div className="space-y-3 mb-8">
                    <button
                        ...
                        className="w-full flex items-center justify-center gap-3 py-2.5 px-4 border border-[rgb(var(--color-border))] rounded-lg text-sm font-medium text-[rgb(var(--color-text-primary))] hover:bg-[rgb(var(--color-surface))] transition-colors"
                    >
                ...
                <p className="text-center text-sm text-[rgb(var(--color-text-secondary))] mt-8">
                    이미 계정이 있으신가요?{' '}
                    <Link href="/login" className="text-[rgb(var(--color-accent))] hover:underline font-medium">
                        로그인
                    </Link>
                </p>
            </div>
